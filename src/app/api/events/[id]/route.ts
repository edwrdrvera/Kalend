...
export async function PATCH(request: Request, { params }: RouteContext) {
  try {
    ...
    if (body.category_id !== undefined && body.category_id !== null && (typeof body.category_id !== "string" || !body.category_id.trim())) return badRequest("category_id must be a non-empty string or null");
