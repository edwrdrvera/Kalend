...
export default function IconRail({
  ...
  return (
    ...
    >
      {/* App mark doubles as the "All Spaces" home button: a branded primary
          tile that reads in both light and dark themes. */}
      <button
        type="button"
        ...
        className={cn(
          "grid size-[30px] place-items-center rounded-[9px] bg-primary transition-shadow hover:bg-primary/90",
