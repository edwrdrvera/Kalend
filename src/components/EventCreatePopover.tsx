  ...
  return (
    ...
    >
      <PopoverPrimitive.Portal>
        ...
        >
          {/* drop-shadow traces the combined outline of the panel and tail. */}
          <PopoverPrimitive.Popup
            ...
            className="animate-in fade-in-0 zoom-in-95 duration-100 outline-hidden"
          >
            <PopoverPrimitive.Title className="sr-only">Create event</PopoverPrimitive.Title>
            {/* The custom tail keeps the anchored visual treatment while Base UI owns dismissal. */}
            <div className="relative rounded-2xl bg-popover text-popover-foreground ring-1 ring-foreground/10">
              <svg
                className="absolute overflow-visible"
                style={{
                  top: `calc(50% - ${TAIL_H / 2}px)`,
                  width: TAIL_W,
                  height: TAIL_H,
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-4 p-4">
                ...
                <div className="flex gap-2">
                  <PopoverPrimitive.Close
                    render={<Button type="button" variant="outline" size="sm" className="flex-1" />}
                  >
                    Cancel
                  </PopoverPrimitive.Close>
